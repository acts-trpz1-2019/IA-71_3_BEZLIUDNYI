...
namespace LibraryMvcCore.Models
{
    public class SampleData
    {
        public static void Initialize(ApplicationContext db)
        {
            ...
            {
                Name = "Детективы",
                CoverFilePath = AppSettings.GenreCoveringsFilePath + @"\detectives.png"
            };

            Genre g2 = new Genre
            {
                Name = "Фантастика",
                CoverFilePath = AppSettings.GenreCoveringsFilePath + @"\fantasy.png"
            };

            Genre g3 = new Genre
            {
                Name = "Книги о программировании",
                CoverFilePath = AppSettings.GenreCoveringsFilePath + @"\programming.png"
            };

            Genre g4 = new Genre
            {
                Name = "Научная фантастика",
                CoverFilePath = AppSettings.GenreCoveringsFilePath + @"\science_fiction.png"
            };

            Genre g5 = new Genre
            {
                Name = "Ужасы",
                CoverFilePath = AppSettings.GenreCoveringsFilePath + @"\horrors.png"
            };

            Genre g6 = new Genre
            {
                Name = "Повести",
                CoverFilePath = AppSettings.GenreCoveringsFilePath + @"\narratives.png"
            };

            Genre g7 = new Genre
            {
                Name = "Приключенческая литература",
                CoverFilePath = AppSettings.GenreCoveringsFilePath + @"\adventures.png"
            };
            ...
            TextBook b1 = new TextBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\А._Азимов_-_Я,_робот.jpg"
            };
            ...
            TextBook b2 = new TextBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\А._К._Дойл_-_Собака_Баскервилей.jpg"
            };
            ...
            TextBook b3 = new TextBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\А._К._Дойл_-_Шерлок_Холмс_на_сцене.jpg"
            };
            ...
            TextBook b4 = new TextBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\Г._Шилдт_-_Csharp_4.0.jpg"
            };
            ...
            TextBook b5 = new TextBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\Г._Шилдт_-_Java_8.jpg"
            };
            ...
            TextBook b6 = new TextBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\Дж._Грин_-_Изучаем_Сsharp.jpg"
            };
            ...
            AudioBook a1 = new AudioBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\Н._Гоголь_-_Ночь_перед_рождеством.jpg"
            };
            ...
            AudioBook a4 = new AudioBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\Р._Брэдбери_-_Убийца.jpg"
            };
            ...
            AudioBook a5 = new AudioBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\С._Кинг_-_Поле_Боя.jpg"
            };
            ...
            AudioBook a6 = new AudioBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\С._Кинг_-_Человек_который_любил_цветы.jpg"
            };
            ...
            AudioBook a7 = new AudioBook
            {
                ...
                CoverFilePath = AppSettings.BookCoveringsFilePath + @"\Ф._Дик_-_Из_глубин_памяти.jpg"
            };
            ...
            db.BookGenres.AddRange(new List<BookGenre>()
            {
                new BookGenre{ Book = b1, Genre = g2 },
                new BookGenre{ Book = b1, Genre = g4 },
                new BookGenre{ Book = b2, Genre = g1 },
                new BookGenre{ Book = b3, Genre = g1 },
                new BookGenre{ Book = b4, Genre = g3 },
                new BookGenre{ Book = b5, Genre = g3 },
                new BookGenre{ Book = b6, Genre = g3 },
                new BookGenre{ Book = a1, Genre = g6 },
                new BookGenre{ Book = a4, Genre = g2 },
                new BookGenre{ Book = a5, Genre = g5 },
                new BookGenre{ Book = a6, Genre = g5 },
                new BookGenre{ Book = a7, Genre = g2 },
                new BookGenre{ Book = a7, Genre = g4 },
            });
                ...
                ContentBlocks = new List<string>
                        {
                            ...
                            "Более 1500 произведений всех жанров в мобильном приложении и на сайте: " +
                            "детективы, фантастика, фэнтези, книги по бизнесу, психологии, для детей, современная и классическая литература. " +
                ...
                ContentBlocks = new List<string>
                            {
                                ...
                                "Наш каталог — это ветвистое дерево. Детективы, приключенчиска литература, фэнтези, фантастика, научно-популярные и бизнес-книги — самые популярные жанры. "
                            }
            };
                ...
                ContentBlocks = new List<string>
                            {
                                ...
                                "планировать и считать, рассказывают книги лучших издательств деловой литературы: " +
            ...
            TitledInfo t8 = new TitledInfo
            {
                ContentBlocks = new List<string>
                            {
                                "Что почитать, чтобы развлечься? Заходите в раздел детективов, приключенческой литературы, фантастики и фэнтези. " +
                                "Там вы найдете новинки и классику любимых жанров. В LitNet каждый сможет выбрать книгу по душе, даже ребенок. " +
